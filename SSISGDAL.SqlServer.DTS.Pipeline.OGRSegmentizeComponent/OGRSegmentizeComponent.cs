...
namespace SSISGDAL.SqlServer.DTS.Pipeline
{
    [DtsPipelineComponent(
        DisplayName = "OGR Segmentize",
        ComponentType = ComponentType.Transform,
        IconResource = "SSISGDAL.SqlServer.DTS.Pipeline.SSISGDAL.ico"
    )]
    public class OGRSegmentizeComponent : OGRTransformation
    {
        ...
        public override void ProvideComponentProperties()
        {
            ...
            //Add input maximum length property
            IDTSCustomProperty100 mlength = ComponentMetaData.CustomPropertyCollection.New();
            mlength.Name = "Maximum Length";
            mlength.Description = "Maximum Length";
            mlength.Value = 0.0;
        }
        ...
        {
            base.PreExecute();
            this.maxLength = (double)ComponentMetaData.CustomPropertyCollection["Maximum Length"].Value;
        }
