...
namespace SSISGDAL.SqlServer.DTS.Pipeline
{
    [DtsPipelineComponent(
        DisplayName = "OGR ExportToWKT",
        ComponentType = ComponentType.Transform,
        IconResource = "SSISGDAL.SqlServer.DTS.Pipeline.SSISGDAL.ico"
    )]
    public class OGRExportToWKTComponent : OGRTransformation
    {
        public override void ProvideComponentProperties()
        {
            ...
            areaColumn.Name = "WKT";
            areaColumn.Description = "WKT";
            areaColumn.SetDataTypeProperties(Microsoft.SqlServer.Dts.Runtime.Wrapper.DataType.DT_NTEXT, 0, 0, 0, 0);
        }
        ...
        public override void transform(ref PipelineBuffer buffer, int defaultOutputId, int inputColumnBufferIndex, int outputColumnBufferIndex)
        {
            ...
            buffer.SetString(outputColumnBufferIndex, wkt);
